export const stars = [
  ...
  },
  {
    ...
    title: 'Links',
    category: 'directory',
    description: 'A curated nebula of personal spaces, tools, and project links.',
    content: 'Navigation hub for sites and web experiences.',
    links: [
      {
        name: 'Setup',
        description: 'Interactive 3D Custom Workstation & Hardware Specs',
        url: '/setup',
        tag: '3D Showcase'
      },
      {
        name: 'Arcade Games',
        description: 'Retro & Creative Mini-Game Suite (Snake, Tetris, Pong, 2048, Minesweeper & more)',
        url: '/play',
        tag: 'Games Hub'
      }
    ],
    tags: ['navigation', 'directory', 'links', 'setup', 'games', 'arcade'],
    color: '#06b6d4', // Cyan
  }
];
